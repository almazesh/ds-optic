...
const CreateComplex = () => {
  ...
  return (
    <div id={cls[mobileModalType === mobileModalTypes.CREATE_COMPLEX ? 'active' : '']} className={cls['create']}>
      ...
      <div>
        ...
        <div className={cls['create-product-btn']}>
        ...
        <div className={cls['create-box']}>
          <p>Комплект по свободной цене</p>
          <span></span>
        </div>
        <div className={cls['create-child']}>
