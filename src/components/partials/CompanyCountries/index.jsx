...
const CompanyCountries = () => {
  ...
  const [countryData, setCountryData] = React.useState(countryCodes)
  const [choose, setChoose] = React.useState(null)
  const [countrySettings, setCountrySettings] = React.useState({
    value: 'Kyrgyzstan'
  }) 
    ...
    <React.Fragment>
      <div className={cls['company']}>
        <div className={cls['company-input']}>
          ...
          <input {...register('country')} placeholder='Страна' type="text" />
        </div>
        <div className={cls['company-input']}>
          <p>Флаг страны</p>
          <ul className={cls['country-list-input']}>
            <input onChange={onSearch} placeholder={countrySettings?.value} onClick={() => setShowMenu(prev => !prev)}  type="text" />
            {
                  ...
                  <div className={cls['country-menu-item']}>
                    {
                      countryData?.map(i => 
                        <li onClick={() => {
                          setChoose(i)
                          setShowMenu(false)
                          setCountrySettings(prev => ({...prev, value: i.name}))
                        }} className='' key={i.code}>
                          <img 
